...
id: about
title: Introduction
description: ZhouJun self-introduction
...
本站点构建于 Docusaurus 框架，参考了 [愧怍](https://kuizuo.cn) 大佬的相关实现。
...
<a href="https://github.com/zhoujun134">
    <img src="https://metrics.lecoq.io/zhoujun134?template=classic&base.activity=0&base.community=0&base.repositories=0&base.metadata=0&isocalendar=1&base=header%2C%20activity%2C%20community%2C%20repositories%2C%20metadata&base.indepth=false&base.hireable=false&isocalendar=false&isocalendar.duration=full-year&config.timezone=Asia%2FShanghai" />
</a>

### ☎️ 联系我
<p>
    <Icon icon="ri:github-line" width="20" heigth="20" />{' '}
    <a href="https://github.com/zhoujun134">Github</a>
</p>

<p>
    <Icon icon="ri:qq-line" width="20" heigth="20" />{' '}
    <a href="http://wpa.qq.com/msgrd?v=3&uin=1161386101&site=qq&menu=yes">QQ</a>
</p>

<p>
    <Icon icon="ri:mail-open-line" width="20" heigth="20" />{' '}
    <a href="mailto:1161386101@qq.com">1161386101@qq.com</a>
</p>
